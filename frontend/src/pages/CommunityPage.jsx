...
export default function CommunityPage() {
  ...
  return (
    <div>
      {/* Sticky top bar */}
      <div style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 300, height: 98, background: 'rgba(8,8,8,0.85)', backdropFilter: 'blur(12px)', borderBottom: '1px solid var(--rule)', display: 'flex', alignItems: 'flex-end', padding: '0 20px 0 20px', justifyContent: 'space-between' }}>
